...
definePageMeta({ title: 'Iniciar sesión' })
  ...
  <div class="max-w-md mx-auto animate-fade-in">
    <div class="pixel-border bg-retro-dark p-6 sm:p-8">
      ...
      <form @submit.prevent="handleSubmit" class="space-y-4">
        ...
        <p class="text-center">
          <NuxtLink to="/olvide-password" class="font-body text-retro-mute text-lg hover:text-retro-cyan transition-all duration-200">
      ...
      <p class="font-body text-retro-mute text-lg text-center mt-6">
        ¿No tienes cuenta?
        <NuxtLink to="/registro" class="text-retro-cyan hover:text-glow-cyan transition-all duration-200">
          Regístrate
        </NuxtLink>
      </p>
    </div>
