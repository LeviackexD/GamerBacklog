<script setup>
// ============================================================
// GameForm — Formulario de crear y editar juegos
// ============================================================
// Se usa en /juegos/nuevo y /juegos/edicion/:id. Recibe un
// game opcional; si existe → modo edición, si no → creación.
// Las etiquetas se manejan como chips: se guardan como string
// separado por comas (form.tags) y se muestran con toggleTag().
